...
const Shop = () => {
    ...
    return ( 
        <div className="shop__contianer">
            ...
            {menItems && <ShopCategory name="Cakes" key="men" items={menItems}/>}
            {womenItems && <ShopCategory name="Set Menu" key="women" items={womenItems}/>}
            {kidsItems && <ShopCategory name="Other" key="kids" items={kidsItems}/>}
        </div>
     );
}
